...
bool BNO08x::run_full_calibration_routine()
{
    ...
    float magf_y = 0;
    float magf_z = 0;
    uint8_t magnetometer_accuracy = (uint8_t) IMUAccuracy::LOWACCURACY;

    float quat_I = 0;
    float quat_J = 0;
    float quat_K = 0;
    float quat_real = 0;
    uint8_t quat_accuracy = (uint8_t) IMUAccuracy::LOWACCURACY;
    ...
    while (1)
    {
        if (data_available())
        {
            ...
            if ((magnetometer_accuracy >= (uint8_t) IMUAccuracy::MEDACCURACY) && (quat_accuracy == (uint8_t) IMUAccuracy::HIGHACCURACY))
                high_accuracy++;
            else
                high_accuracy = 0;
